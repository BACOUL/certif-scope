        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-[#F8FAFC] rounded-xl border border-slate-200 p-6">
            ...
            <p className="text-sm text-[#475569]">
              ...
              which includes emissions generated by suppliers and partners.
            </p>
          </div>
          ...
          <div className="bg-[#F8FAFC] rounded-xl border border-slate-200 p-6">
            ...
            <p className="text-sm text-[#475569]">
              ...
              as part of ESG risk analysis and financing decisions.
            </p>
          </div>
          ...
          <div className="bg-[#F8FAFC] rounded-xl border border-slate-200 p-6">
            ...
            <p className="text-sm text-[#475569]">
              The VSME standard was designed to help SMEs respond to these
              requests with a simplified and proportionate framework.
            </p>
          </div>
        </div>

        <p className="mt-10 text-center text-sm text-[#64748B] max-w-3xl mx-auto">
          This attestation does not constitute a statutory CSRD filing.
          It supports pre-compliance, partner reporting and ESG questionnaires.
        </p>
      </section>
